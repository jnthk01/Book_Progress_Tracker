        ...
        <div style={commonStyles.card}>
          <div style={{ position: 'absolute', top: '20px', left: '20px' }}>
            <Link 
              to="/home" 
              style={{ 
                ...commonStyles.smallButtonSecondary, 
                color: 'black' 
              }}
            >
              Home
          ...
          {isLoading ? (
            ...
            <div style={commonStyles.bookListContainer}>
              {books.map((book, index) => {
                const progress = typeof book.progress_percent === 'number' 
                  ? book.progress_percent 
                  : 0;
                const isHovered = hoveredCard === book.id;
                const isSearching = searchTitle.length > 0;
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      ...(isSearching ? {} : { animationDelay: `${index * 0.1}s` })
                    }}
                    className={isSearching ? "" : "fade-in"}
