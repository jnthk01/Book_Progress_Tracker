    ...
    <div style={commonStyles.container} className="fade-in">
      <div style={{
        ...
        <div style={{ position: 'absolute', top: '20px', left: '20px' }}>
          <Link to="/home" style={{...commonStyles.smallButtonSecondary, color: 'dimgray'}}>Home</Link>
        </div>
        
        <h2 style={commonStyles.title}>Edit Book</h2>
        <p style={commonStyles.subtitle}>Update your book details</p>
